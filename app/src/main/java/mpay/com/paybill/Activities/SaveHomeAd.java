...
public class SaveHomeAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_bar_adhome);
        ButterKnife.bind(this);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle("Change Home Advertisement");
        ...
        buttonChoose1 = (Button) findViewById(R.id.buttonChoose2);
        ...
        buttonChoose2 = (Button) findViewById(R.id.buttonChoose3);
    ...
    private void uploadVideo() {
        class UploadVideo extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                uploading = ProgressDialog.show(SaveHomeAd.this, "Uploading Video", "Please wait...", false, false);
            }
...
//        }
    ...
    protected void showDialog() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SaveHomeAd.this);
