/*
package mpay.com.paybill.Adapter;
...
public class SearchResultsListAdapter extends RecyclerView.Adapter<SearchResultsListAdapter.ViewHolder> {
    ...
    private List<PaybillWrapper> mDataSet = new ArrayList<>();

    private int mLastAnimatedItemPosition = -1;

    public interface OnItemClickListener {
        void onClick(PaybillWrapper colorWrapper);
    }
    ...
    public void swapData(List<PaybillWrapper> mNewDataSet) {
    ...
    public void onBindViewHolder(SearchResultsListAdapter.ViewHolder holder, final int position) {
        ...
        PaybillWrapper colorSuggestion = mDataSet.get(position);
